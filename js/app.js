(() => {
    ...
    da.init();
    document.querySelectorAll(".block-switcher__button").forEach((button => {
        button.addEventListener("click", (function() {
            document.querySelector(".block-switcher__button-active")?.classList.remove("block-switcher__button-active");
            this.classList.add("block-switcher__button-active");
        }));
    }));
    window["FLS"] = true;
    addLoadedClass();
